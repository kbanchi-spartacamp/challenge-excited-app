<x-guest-layout>
    <section class="relative ">
        <div class="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
            ...
            background-image: url('/images/challenge_1.jpg');">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex mb-10">
            <div class="w-full lg:w-9/12 px-4 ">
                ...
                <p class="text-lg leading-relaxed mt-4 mb-4 text-blueGray-600">
                    転職、恋愛、勉強、人生の転換期・・・<br>
                    チャレンジしたい事はあるのに、失敗への恐怖が勝ってチャレンジが出来ないあなたにきっかけをもたらします。
                </p>
            </div>
        ...
        <div class="flex mb-10">
            <div class="w-full lg:w-3/12 lg:max-w-lg md:w-1/2">
                <img class="object-cover object-center rounded-lg h-60" alt="hero" src="images/study_night_girl.png">
            </div>
            <div class="w-full lg:w-9/12 px-4 ">
                <h2 class="text-4xl font-semibold text-blueGray-700">
                    人生に後悔を残したくない
        ...
        <div class="flex mb-10">
            <div class="w-full lg:w-9/12 px-4 ">
                ...
                <p class="text-lg leading-relaxed mt-4 mb-4 text-blueGray-600">
                    環境、人、時間配分の変化・・・<br>
                    いつも手元に挑戦のきっかけがあれば、どんな些細なこともチャレンジするきっかけになります。
                </p>
            </div>
            <div class="w-full lg:w-6/12 lg:max-w-lg md:w-1/2 ">
