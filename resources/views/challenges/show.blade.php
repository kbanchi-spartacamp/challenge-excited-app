<x-app-layout>
    {{-- <div class="container lg:w-3/4 md:w-4/5 w-11/12 mx-auto my-8 px-4 py-4 bg-yellow-100 shadow-md"> --}}
<div class="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 py-5">
        <div class="rounded-lg w-5/6 shadow-xl bg-gray-900 text-gray-400">
            {{-- <div class="border-b border-yellow-800 px-8 py-3">
        ...
        <article class="mb-2">
            ...
            <h2 class="text-center font-bold font-sans break-normal text-white pt-6 pb-1 text-3xl md:text-4xl mb-10">
                {{ $challenge->title }}
            </h2>
